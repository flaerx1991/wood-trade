...
.. _`Twig bundle`:                http://github.com/Anomareh/PHP-Twig.tmbundle
.. _`Jinja syntax plugin`:        http://jinja.pocoo.org/docs/integration/#vim
.. _`vim-twig plugin`:            http://github.com/lumiliet/vim-twig
.. _`Twig syntax plugin`:         http://plugins.netbeans.org/plugin/37069/php-twig
.. _`Twig plugin`:                http://github.com/pulse00/Twig-Eclipse-Plugin
.. _`Twig language definition`:   http://github.com/gabrielcorpse/gedit-twig-template-language
.. _`Twig syntax mode`:           http://github.com/bobthecow/Twig-HTML.mode
.. _`other Twig syntax mode`:     http://github.com/muxx/Twig-HTML.mode
.. _`Notepad++ Twig Highlighter`: http://github.com/Banane9/notepadplusplus-twig
.. _`web-mode.el`:                http://web-mode.org/
.. _`regular expressions`:        http://secure.php.net/manual/en/pcre.pattern.php
.. _`PHP-twig for atom`:          http://github.com/reesef/php-twig
.. _`TwigFiddle`:                 http://twigfiddle.com/
.. _`Twig pack`:                  http://marketplace.visualstudio.com/items?itemName=bajdzis.vscode-twig-pack
