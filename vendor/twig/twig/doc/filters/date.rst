...
.. _`strtotime`:            http://secure.php.net/strtotime
.. _`DateTime`:             http://secure.php.net/DateTime
.. _`DateInterval`:         http://secure.php.net/DateInterval
.. _`date`:                 http://secure.php.net/date
.. _`DateInterval::format`: http://secure.php.net/DateInterval.format
