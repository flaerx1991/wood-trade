...
.. _`rot13`:               http://secure.php.net/manual/en/function.str-rot13.php
.. _`tests/Twig/Fixtures`: http://github.com/twigphp/Twig/tree/2.x/tests/Fixtures
.. _`tests/Twig/Node`:     http://github.com/twigphp/Twig/tree/2.x/tests/Node
